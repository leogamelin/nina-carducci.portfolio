(function($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    nextImage() {
      ...
      // Augmenter l'index et utiliser le modulo pour s'assurer que l'index reste dans la plage de la collection d'images
      index = (index + 1) % imagesCollection.length;
    
      // Utiliser le nouvel index pour définir la prochaine image
    ...
    filterByTag() {
      ...
      $(this).addClass("active"); // Ajout de la classe "active" à l'élément sélectionné
